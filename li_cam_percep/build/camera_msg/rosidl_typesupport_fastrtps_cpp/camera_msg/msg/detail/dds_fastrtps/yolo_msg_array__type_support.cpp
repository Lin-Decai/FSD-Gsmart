...
#include "camera_msg/msg/detail/yolo_msg_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: cones
  {
    ...
    for (size_t i = 0; i < size; i++) {
      camera_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.cones[i],
        cdr);
    }
  }
  ...
  camera_msg::msg::YoloMsgArray & ros_message)
{
  ...
  // Member: cones
  {
    ...
    for (size_t i = 0; i < size; i++) {
      camera_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: cones
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        camera_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: cones
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        camera_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_YoloMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = camera_msg::msg::YoloMsgArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const camera_msg::msg::YoloMsgArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<camera_msg::msg::YoloMsgArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YoloMsgArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const camera_msg::msg::YoloMsgArray *>(
...
static size_t _YoloMsgArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YoloMsgArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YoloMsgArray__callbacks = {
  "camera_msg::msg",
  "YoloMsgArray",
...
static rosidl_message_type_support_t _YoloMsgArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloMsgArray__callbacks,
...
{
  return &camera_msg::msg::typesupport_fastrtps_cpp::_YoloMsgArray__handle;
}
