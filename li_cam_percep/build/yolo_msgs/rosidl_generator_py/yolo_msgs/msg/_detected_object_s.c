...
bool yolo_msgs__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_msgs.msg._detected_object.DetectedObject", full_classname_dest, 45) == 0);
  }
  yolo_msgs__msg__DetectedObject * ros_message = _ros_message;
  {  // class_name
...
PyObject * yolo_msgs__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_msgs.msg._detected_object");
