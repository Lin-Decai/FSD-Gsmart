...
#include "yolo_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedObject__ros_msg_type = yolo_msgs__msg__DetectedObject;
...
static uint32_t _DetectedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_msgs__msg__DetectedObject(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msgs__msg__DetectedObject;
    is_plain =
      (
...
static size_t _DetectedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolo_msgs__msg__DetectedObject(
