...
{
  new (message_memory) yolo_msgs::msg::DetectedObjectArray(_init);
}

void DetectedObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msgs::msg::DetectedObjectArray *>(message_memory);
  typed_message->~DetectedObjectArray();
}

size_t size_function__DetectedObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolo_msgs::msg::DetectedObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolo_msgs::msg::DetectedObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolo_msgs::msg::DetectedObject> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolo_msgs::msg::DetectedObject *>(
    get_const_function__DetectedObjectArray__objects(untyped_member, index));
  auto & value = *reinterpret_cast<yolo_msgs::msg::DetectedObject *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolo_msgs::msg::DetectedObject *>(
    get_function__DetectedObjectArray__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolo_msgs::msg::DetectedObject *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(yolo_msgs::msg::DetectedObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolo_msgs::msg::DetectedObject>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs::msg::DetectedObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(yolo_msgs::msg::DetectedObjectArray),
...
get_message_type_support_handle<yolo_msgs::msg::DetectedObjectArray>()
{
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msgs, msg, DetectedObjectArray)() {
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObjectArray_message_type_support_handle;
}
