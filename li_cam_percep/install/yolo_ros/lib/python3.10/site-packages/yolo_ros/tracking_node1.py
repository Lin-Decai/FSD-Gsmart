...
class TrackingNode(Node):
    def __init__(self) -> None:
        ...
        self.get_logger().info("TrackingNode initialized (Foxy compatible)")
    ...
    def create_tracker(self, tracker_yaml: str) -> BaseTrack:
        ...
        assert cfg.tracker_type in ["bytetrack", "botsort"], f"Only support 'bytetrack' and 'botsort', got '{cfg.tracker_type}'"
        ...
        if len(detection_list) > 0:
            ...
            if len(tracks) > 0:
                for t in tracks:
                    ...
                    track_id = str(int(tracked_box.id)) if tracked_box.is_track else ""
