...
{
  new (message_memory) skidpad_msgs::msg::ControlCommand(_init);
}

void ControlCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<skidpad_msgs::msg::ControlCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlCommand_message_member_array[3] = {
  {
    ...
    offsetof(skidpad_msgs::msg::ControlCommand, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::ControlCommand, throttle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::ControlCommand, steering_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(skidpad_msgs::msg::ControlCommand),
...
get_message_type_support_handle<skidpad_msgs::msg::ControlCommand>()
{
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::ControlCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skidpad_msgs, msg, ControlCommand)() {
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::ControlCommand_message_type_support_handle;
}
