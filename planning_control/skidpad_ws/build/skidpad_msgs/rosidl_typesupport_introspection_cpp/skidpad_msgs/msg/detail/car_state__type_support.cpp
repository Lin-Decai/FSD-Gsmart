...
{
  new (message_memory) skidpad_msgs::msg::CarState(_init);
}

void CarState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<skidpad_msgs::msg::CarState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CarState_message_member_array[3] = {
  {
    ...
    offsetof(skidpad_msgs::msg::CarState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::CarState, car_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<skidpad_msgs::msg::CarStateDt>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::CarState, car_state_dt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CarState_message_members = {
  ...
  3,  // number of fields
  sizeof(skidpad_msgs::msg::CarState),
...
{
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::CarState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skidpad_msgs, msg, CarState)() {
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::CarState_message_type_support_handle;
}
