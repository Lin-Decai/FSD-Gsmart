...
bool skidpad_msgs__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("skidpad_msgs.msg._trajectory.Trajectory", full_classname_dest, 39) == 0);
  }
  skidpad_msgs__msg__Trajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // trajectory
    ...
    if (!skidpad_msgs__msg__TrajectoryPoint__Sequence__init(&(ros_message->trajectory), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create skidpad_msgs__msg__TrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    skidpad_msgs__msg__TrajectoryPoint * dest = ros_message->trajectory.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!skidpad_msgs__msg__trajectory_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // remaining_distance
    ...
    if (!std_msgs__msg__float64__convert_from_py(field, &ros_message->remaining_distance)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * skidpad_msgs__msg__trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("skidpad_msgs.msg._trajectory");
  ...
  {  // trajectory
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = skidpad_msgs__msg__trajectory_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // remaining_distance
    PyObject * field = NULL;
    field = std_msgs__msg__float64__convert_to_py(&ros_message->remaining_distance);
    if (!field) {
      return NULL;
    }
    {
