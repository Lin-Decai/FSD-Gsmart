...
#ifndef SKIDPAD_MSGS__MSG__DETAIL__CAR_STATE_DT__TRAITS_HPP_
#define SKIDPAD_MSGS__MSG__DETAIL__CAR_STATE_DT__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "car_state_a: ";
    to_flow_style_yaml(msg.car_state_a, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: car_state_a
  {
    ...
    out << "car_state_a:\n";
    to_block_style_yaml(msg.car_state_a, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
...
inline void to_yaml(
  const skidpad_msgs::msg::CarStateDt & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const skidpad_msgs::msg::CarStateDt & msg)
{
  return skidpad_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<skidpad_msgs::msg::CarStateDt>()
{
  return "skidpad_msgs::msg::CarStateDt";
}

template<>
inline const char * name<skidpad_msgs::msg::CarStateDt>()
{
  return "skidpad_msgs/msg/CarStateDt";
}

template<>
struct has_fixed_size<skidpad_msgs::msg::CarStateDt>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Pose2D>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<skidpad_msgs::msg::CarStateDt>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Pose2D>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<skidpad_msgs::msg::CarStateDt>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SKIDPAD_MSGS__MSG__DETAIL__CAR_STATE_DT__TRAITS_HPP_
