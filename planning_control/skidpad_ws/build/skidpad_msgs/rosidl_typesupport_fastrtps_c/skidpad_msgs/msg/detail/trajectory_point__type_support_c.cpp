...
#include "skidpad_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // pts
#include "std_msgs/msg/detail/float64__functions.h"  // acc, curvature, r, velocity, yaw
...
using _TrajectoryPoint__ros_msg_type = skidpad_msgs__msg__TrajectoryPoint;
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
