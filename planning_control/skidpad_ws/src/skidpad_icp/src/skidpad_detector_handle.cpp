...
void SkidpadDetectorHandle::loadParameters() {
  ...
  this->declare_parameter<std::string>("cluster_filtered_topic_name", "/perception/lidar_cluster");
...
void SkidpadDetectorHandle::clusterFilteredCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
