...
#include "skidpad_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const skidpad_msgs::msg::TrajectoryPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  skidpad_msgs::msg::TrajectoryPoint &);
size_t get_serialized_size(
  const skidpad_msgs::msg::TrajectoryPoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const skidpad_msgs::msg::Trajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: trajectory
  {
    ...
    for (size_t i = 0; i < size; i++) {
      skidpad_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.remaining_distance,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  skidpad_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  // Member: trajectory
  {
    ...
    for (size_t i = 0; i < size; i++) {
      skidpad_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        skidpad_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        skidpad_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const skidpad_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<skidpad_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_skidpad_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<skidpad_msgs::msg::Trajectory>()
{
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skidpad_msgs, msg, Trajectory)() {
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
