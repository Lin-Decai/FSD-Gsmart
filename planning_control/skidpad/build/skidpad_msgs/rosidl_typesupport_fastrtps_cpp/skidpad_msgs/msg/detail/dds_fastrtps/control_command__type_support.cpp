...
#include "skidpad_msgs/msg/detail/control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const skidpad_msgs::msg::ControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  skidpad_msgs::msg::ControlCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs::msg::ControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const skidpad_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<skidpad_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skidpad_msgs, msg, ControlCommand)() {
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
