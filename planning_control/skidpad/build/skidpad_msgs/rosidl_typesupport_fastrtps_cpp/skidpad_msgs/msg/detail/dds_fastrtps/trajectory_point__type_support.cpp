...
#include "skidpad_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const skidpad_msgs::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  skidpad_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: pts
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs::msg::TrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const skidpad_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<skidpad_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skidpad_msgs, msg, TrajectoryPoint)() {
  return &skidpad_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
