...
static const _TrajectoryPoint_type_support_symbol_names_t _TrajectoryPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skidpad_msgs, msg, TrajectoryPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skidpad_msgs, msg, TrajectoryPoint)),
  }
};
...
{
  return &::skidpad_msgs::msg::rosidl_typesupport_cpp::TrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skidpad_msgs, msg, TrajectoryPoint)() {
  return get_message_type_support_handle<skidpad_msgs::msg::TrajectoryPoint>();
}
