...
{
  new (message_memory) skidpad_msgs::msg::TrajectoryPoint(_init);
}

void TrajectoryPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<skidpad_msgs::msg::TrajectoryPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryPoint_message_member_array[6] = {
  {
    ...
    offsetof(skidpad_msgs::msg::TrajectoryPoint, pts),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::TrajectoryPoint, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::TrajectoryPoint, curvature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::TrajectoryPoint, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::TrajectoryPoint, r),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(skidpad_msgs::msg::TrajectoryPoint, acc),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryPoint_message_members = {
  ...
  6,  // number of fields
  sizeof(skidpad_msgs::msg::TrajectoryPoint),
...
get_message_type_support_handle<skidpad_msgs::msg::TrajectoryPoint>()
{
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skidpad_msgs, msg, TrajectoryPoint)() {
  return &::skidpad_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
