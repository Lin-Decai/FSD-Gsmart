...
static const _TrajectoryPoint_type_support_symbol_names_t _TrajectoryPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skidpad_msgs, msg, TrajectoryPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, skidpad_msgs, msg, TrajectoryPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, skidpad_msgs, msg, TrajectoryPoint)() {
  return &::skidpad_msgs::msg::rosidl_typesupport_c::TrajectoryPoint_message_type_support_handle;
}
