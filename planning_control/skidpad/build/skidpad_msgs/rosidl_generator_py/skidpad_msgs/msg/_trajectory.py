...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from skidpad_msgs.msg import TrajectoryPoint
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'trajectory': 'sequence<skidpad_msgs/TrajectoryPoint>',
        'remaining_distance': 'std_msgs/Float64',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['skidpad_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float64
        self.remaining_distance = kwargs.get('remaining_distance', Float64())
    ...
    def remaining_distance(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'remaining_distance' field must be a sub message of type 'Float64'"
