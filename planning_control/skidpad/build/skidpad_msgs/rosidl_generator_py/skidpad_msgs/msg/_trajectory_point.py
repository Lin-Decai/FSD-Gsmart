...
class TrajectoryPoint(metaclass=Metaclass_TrajectoryPoint):
    ...
    _fields_and_field_types = {
        ...
        'curvature': 'std_msgs/Float64',
        'velocity': 'std_msgs/Float64',
        'r': 'std_msgs/Float64',
        'acc': 'std_msgs/Float64',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.pts = kwargs.get('pts', Point())
        from std_msgs.msg import Float64
        self.yaw = kwargs.get('yaw', Float64())
        from std_msgs.msg import Float64
        self.curvature = kwargs.get('curvature', Float64())
        from std_msgs.msg import Float64
        self.velocity = kwargs.get('velocity', Float64())
        from std_msgs.msg import Float64
        self.r = kwargs.get('r', Float64())
        from std_msgs.msg import Float64
        self.acc = kwargs.get('acc', Float64())
    ...
    def pts(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'pts' field must be a sub message of type 'Point'"
        self._pts = value
    ...
    def curvature(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float64), \
                "The 'curvature' field must be a sub message of type 'Float64'"
    ...
    def velocity(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float64), \
                "The 'velocity' field must be a sub message of type 'Float64'"
    ...
    def r(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float64), \
                "The 'r' field must be a sub message of type 'Float64'"
        self._r = value
    ...
    def acc(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float64), \
                "The 'acc' field must be a sub message of type 'Float64'"
        self._acc = value
