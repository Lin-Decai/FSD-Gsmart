...
#include "skidpad_msgs/msg/detail/control_command__rosidl_typesupport_fastrtps_c.h"
...
using _ControlCommand__ros_msg_type = skidpad_msgs__msg__ControlCommand;
...
size_t get_serialized_size_skidpad_msgs__msg__ControlCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlCommand__ros_msg_type * ros_message = static_cast<const _ControlCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ControlCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_skidpad_msgs__msg__ControlCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skidpad_msgs
size_t max_serialized_size_skidpad_msgs__msg__ControlCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs__msg__ControlCommand;
    is_plain =
      (
...
static size_t _ControlCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skidpad_msgs__msg__ControlCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skidpad_msgs, msg, ControlCommand)() {
