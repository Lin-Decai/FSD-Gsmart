...
#include "skidpad_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "skidpad_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "skidpad_msgs/msg/detail/trajectory_point__functions.h"  // trajectory
#include "std_msgs/msg/detail/float64__functions.h"  // remaining_distance
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skidpad_msgs, msg, TrajectoryPoint)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_skidpad_msgs
...
using _Trajectory__ros_msg_type = skidpad_msgs__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectory
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, skidpad_msgs, msg, TrajectoryPoint
      )()->data);
  ...
  // Field name: remaining_distance
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->remaining_distance, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectory
  {
    ...
    if (ros_message->trajectory.data) {
      skidpad_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->trajectory);
    }
    if (!skidpad_msgs__msg__TrajectoryPoint__Sequence__init(&ros_message->trajectory, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skidpad_msgs
size_t get_serialized_size_skidpad_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
  ...
  current_alignment += get_serialized_size_std_msgs__msg__Float64(
    &(ros_message->remaining_distance), current_alignment);
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_skidpad_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skidpad_msgs
size_t max_serialized_size_skidpad_msgs__msg__Trajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_skidpad_msgs__msg__TrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = skidpad_msgs__msg__Trajectory;
    is_plain =
      (
      offsetof(DataType, remaining_distance) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skidpad_msgs__msg__Trajectory(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skidpad_msgs, msg, Trajectory)() {
