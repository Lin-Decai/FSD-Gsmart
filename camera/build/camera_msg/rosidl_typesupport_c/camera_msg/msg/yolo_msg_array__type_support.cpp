...
static const _YoloMsgArray_type_support_symbol_names_t _YoloMsgArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera_msg, msg, YoloMsgArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, camera_msg, msg, YoloMsgArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, camera_msg, msg, YoloMsgArray)() {
  return &::camera_msg::msg::rosidl_typesupport_c::YoloMsgArray_message_type_support_handle;
}
