...
static const _DetectedObjectArray_type_support_symbol_names_t _DetectedObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, DetectedObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msgs, msg, DetectedObjectArray)),
  }
};
...
{
  return &::yolo_msgs::msg::rosidl_typesupport_cpp::DetectedObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolo_msgs, msg, DetectedObjectArray)() {
  return get_message_type_support_handle<yolo_msgs::msg::DetectedObjectArray>();
}
