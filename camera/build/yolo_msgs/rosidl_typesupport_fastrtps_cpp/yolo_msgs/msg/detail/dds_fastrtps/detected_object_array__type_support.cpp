...
#include "yolo_msgs/msg/detail/detected_object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolo_msgs::msg::DetectedObject &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yolo_msgs::msg::DetectedObject &);
size_t get_serialized_size(
  const yolo_msgs::msg::DetectedObject &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const yolo_msgs::msg::DetectedObjectArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::DetectedObjectArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msgs::msg::DetectedObjectArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, DetectedObjectArray)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjectArray__handle;
}
