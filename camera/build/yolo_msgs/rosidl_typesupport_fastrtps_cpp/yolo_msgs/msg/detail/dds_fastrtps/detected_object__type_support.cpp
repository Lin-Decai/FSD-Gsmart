...
#include "yolo_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolo_msgs::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::DetectedObject & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, DetectedObject)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
